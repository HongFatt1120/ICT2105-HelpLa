...
public class MapActivity extends AppCompatActivity implements OnMapReadyCallback,
    ...
    public void onConfirmPressed(View v){
        ...
        Intent i = new Intent(this, CreatePostFragment.class);
    ...
    private void init(){
        ...
        mPlaceAutocompleteAdapter = new PlaceAutocompleteAdapter(getApplication(), mGoogleApiClient,
                LAT_LNG_BOUNDS, null);
    ...
    private void geoLocate(){
        ...
        if(list.size() > 0){
            ...
            longtitude = Double.toString(address.getLongitude());
